...
function mytheme_enqueue_styles() {
	...
	// Enqueue Scripts
	$script_path      = get_template_directory() . '/build/js/frontend.js';
	$script_url       = get_template_directory_uri() . '/build/js/frontend.js';
	$script_asset     = get_template_directory() . '/build/js/frontend.asset.php';
	...
	if ( file_exists( $script_asset ) ) {
		$script_data = include $script_asset;
	}

	wp_register_script(
		'am-landing-page-script',
		$script_url,
...
function am_landing_page_shortcode() {
	...
	wp_enqueue_script( 'am-landing-page-script' );
	...
	?>
	<div class="am-landing-page-style wpforms-formpages-wrapper">
		<section class="hero">
		...
		<div class="thumbnail" onclick="AM_playVideo()">
